...
public class RestaurantDaoImpl implements RestaurantDAO {
    ...
    private final String RESTAURANT_INSERT = "insert into restaurant (`RName`,`CusineType`,`Address`,`Rating`,`Available`,`Rimage`) values(?,?,?,?,?,?,?)";
    private final String FETCH_ALL = "select * from restaurant";
    private final String FETCH_SPECIFIC = "select * from restaurant where R_ID=?";
