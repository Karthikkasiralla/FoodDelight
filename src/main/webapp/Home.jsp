...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href=https://th.bing.com/th/id/OIP.GQ30tYzrobb44Z1dL0VLPQHaHa?w=165&h=180&c=7&pcl=1b1a19&r=0&o=5&dpr=1.3&pid=1.7" type="image/png">
...
.restaurant-grid {
    display: grid;
    grid-template-columns: repeat(4, 1fr); /* Ensures exactly 4 restaurants per row */
    gap: 20px;
    padding: 20px 0;
...
<body>
    ...
    <header>
        <div class="logo">
            <a href="#Home">
                <img src="https://th.bing.com/th/id/OIP.GQ30tYzrobb44Z1dL0VLPQHaHa?w=165&h=180&c=7&pcl=1b1a19&r=0&o=5&dpr=1.3&pid=1.7" alt="Logo">
            </a>
            <div class="app-name">
    Food<span>Delight</span>
        ...
        <ul class="items">
            ...
            <li><a href="RestaurantHome.jsp">🔓 Logout</a></li>
            <li><a href="OrderHistory">🛒 Order History</a></li>
             <li><a href="Cart.jsp"> <i class="fa-sharp fa-solid fa-cart-plus" style="color: #32ae19;"></i>Cart</a></li>
            <li><a href="javascript:void(0);" id="location-link">📍 Location <span class="location">Bangalore</span></a></li>
        ...
        <div class="brand-carousel" id="brand-carousel">
            ...
            <% 
                List<String[]> brands = List.of(
                    new String[]{"https://res.cloudinary.com/dko49jfq3/image/upload/v1732369220/2560px-McDonald_27s_logo.svg_yt1eht.png", "McDonald's"},
                    ...
                    new String[]{"https://res.cloudinary.com/dko49jfq3/image/upload/v1732369310/h6yyfduc5f681_hepcp9.png", "StarBucks"},
...
<!-- ----------------------------------------------------------------------------------------------- -->
   ...
   <div class="explore-menu-section pt-5 pb-5">
    ...
    <!-- Only form submit button, removing <a> tag -->
    <button type="submit">View Menu</button>
        ...
        %>
        <p class="no-restaurants-text">No restaurants found. come back  later!</p>
        <% } %>
    </div>
</div>
    ...
    <!-- Footer -->
    <footer>
        <p>&copy; 2025 Food Delivery Service</p>
    </footer>
