...
.app-name span {
    ...
    font-size: 36px; /* Adjust for desired size */
    font-weight: bold; /* Bold to stand out */
    color: #007fff; /* Blue to match the logo */
    text-align: center; /* Center alignment */
}

.app-name span {
    color: #000000; /* Black for contrast */
    font-style: italic; /* Italic to add dynamic flair */
}
...
@media (max-width: 600px) { /* For mobile screens */
    .restaurant-grid {
        ...
        .footer-content .points {
            text-align: center;
            margin-top: 10px;
        }

        .footer-content .points ul {
            list-style: none;
            padding: 0;
            margin: 0;
        }

        .footer-content .points ul li {
            margin: 5px 0;
        }

        .footer-content .points ul li a {
            text-decoration: none;
            color: #333;
        }
...
<body>
  ...
  <header>
    <div class="logo">
        <a href="#home">
            <img src="https://th.bing.com/th/id/OIP.GQ30tYzrobb44Z1dL0VLPQHaHa?w=165&h=180&c=7&pcl=1b1a19&r=0&o=5&dpr=1.3&pid=1.7" alt="Logo" height="50" width="50">
        </a>
        <div class="app-name">
    ...
    <ul class="items">
        ...
        <li><a href="#">📍 Location <span class="location">Bangalore</span></a></li>
    </ul>
</header>
...
<!-- ----------------------------------------------------------------------------------------------- -->
   ...
   <div class="explore-menu-section pt-5 pb-5">
    <div class="container">
        ...
        %>
        <p class="no-restaurants-text">No restaurants found. Please come back later!</p>
        <% } %>
    </div>
</div>
